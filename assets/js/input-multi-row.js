        ...
        $.each(options.data,function(key,objek){
          ...
          $.each(jsonCol,(ind,obj)=>{
              ...
              if (obj.type == 'text') {
                ...
                row += "<td><input type=\"hidden\" value=\""+objek[obj.id]+"\" name=\""+nama+"["+key+"]["+obj.id+"]\" class=\""+obj.id+"\" /><input type=\"file\" name=\""+obj.id+"_"+key+"\" class=\"input-sm "+obj.id+"\" "+attr+"/></td>";
    ...
    this.closest('div').find(".btnplus_"+nama+"").click(()=>{
        ...
        $.each(jsonCol,(ind,obj)=>{
            ...
            if (obj.type == 'text') {
              ...
              row += "<td><input type=\"hidden\" name=\""+nama+"["+num+"]["+obj.id+"]\" class=\""+obj.id+"\" /><input type=\"file\" name=\""+obj.id+"_"+num+"\" class=\"input-sm "+obj.id+"\" "+attr+"/></td>";
            }else if(obj.type == 'autocomplete'){
