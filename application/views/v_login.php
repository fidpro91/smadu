...
<div class="login-box">
  <div class="login-logo">
    <a href="<?=site_url()?>assets/index2.html"><b>SIAKAD</b>APP</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <form method="post" autocomplete="off">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" name="user_name" id="user_name" placeholder="Username" required="true">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control" name="user_password" id="user_password" placeholder="Password" required="true">
